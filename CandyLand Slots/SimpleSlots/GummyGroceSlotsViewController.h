//
//  GummyGroceSlotsViewController.h
//  Candy Land Slots
//
...
@interface GummyGroceSlotsViewController : ViewController <GameCenterManagerDelegate, GKLeaderboardViewControllerDelegate, GKAchievementViewControllerDelegate, NSURLConnectionDelegate>{
...
- (IBAction)showFreeGame:(id)sender;
