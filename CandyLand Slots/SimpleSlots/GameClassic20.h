...
@interface GameClassic20 : ViewController <GameCenterManagerDelegate, GKLeaderboardViewControllerDelegate, GKAchievementViewControllerDelegate, NSURLConnectionDelegate>{
